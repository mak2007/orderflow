...
(function() {
  ...
  function renderGuysPanel(container) {
    ...
    const enrichedGuys = guysList.map(guy => {
      const payCalc = calculateWorkerPay(guy.completedOrders, guy.successRate);
      ...
      totalTeamCompletedOrders += Number(guy.completedOrders || 0);
